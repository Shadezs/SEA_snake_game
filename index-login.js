...
window.snapKitInit = function () {
  ...
  snap.loginkit.mountButton(loginButtonIconId, {
    clientId: '2b3db8f5-200d-4be7-8b38-53c8dfc0ea54', /*MY clientid from the development client ID on snapckit*/
    redirectURI: 'https://sea-snake-game.glitch.me/', /*YOU CHANGE: Must be changed to your glitch project's url AND added as the redirect URI on snapkit */
    scopeList: [
      'user.display_name',
      'user.bitmoji.avatar',
    ],
